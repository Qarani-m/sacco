...
exports.approveLoan = async (req, res) => {
  try {
    ...
    if (loan.workflow_id) {
      ...
      // If loan is fully approved, update approved amount
      if (result.status === 'approved') {
        await Loan.approve(loanId, approved_amount || loan.requested_amount);
      }
    ...
    // Fallback to old 2/3 admin approval system (for backward compatibility)
